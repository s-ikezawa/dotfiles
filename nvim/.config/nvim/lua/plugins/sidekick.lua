...
vim.keymap.set("n", "<leader>aa", function() require("sidekick.cli").select() end, { desc = "Select CLI" })
vim.keymap.set("n", "<leader>ac", function() require("sidekick.cli").toggle({ name = "claude", focus = true }) end, { desc = "Toggle Claude Code" })
...
vim.keymap.set("n", "<leader>ap", function() require("sidekick.cli").prompt() end, { desc = "Select Prompt" })
