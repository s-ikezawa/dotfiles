...
-- 保存
map("n", "<leader>fs", ":w<CR>", desc("ファイルを保存"))
...
-- ウィンドウ分割
map("n", "<leader>wv", ":vsplit<CR>", desc("垂直分割"))
map("n", "<leader>wh", ":split<CR>", desc("水平分割"))

-- ウィンドウを閉じる
map("n", "<leader>wq", ":q<CR>", desc("ウィンドウを閉じる"))
map("n", "<leader>wQ", ":qa<CR>", desc("すべてのウィンドウを閉じる"))
...
map("n", "<leader>qo", ":copen<CR>", desc("クイックフィックスを開く"))
map("n", "<leader>qc", ":cclose<CR>", desc("クイックフィックスを閉じる"))
...
-- 現在のファイルパスをコピー
map("n", "<leader>fp", ':let @+ = expand("%:p")<CR>', desc("ファイルパスをコピー"))
